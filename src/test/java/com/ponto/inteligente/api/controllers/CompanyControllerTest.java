...
public class CompanyControllerTest {
	...
	private static final String FIND_COMPANY_BY_CNPJ = "/api/company/cnpj/";
	private static final Long ID = Long.valueOf(1);
	private static final String CNPJ = "51463645000100";
	private static final String COMPANY_NAME = "Empresa XYZ";
	...
	public void testFindCompanyWithInvalidCnpj() throws Exception {
		...
		mvc.perform(MockMvcRequestBuilders.get(FIND_COMPANY_BY_CNPJ + CNPJ).accept(MediaType.APPLICATION_JSON))
	...
	@Test
	@WithMockUser
	public void testFindCompanyWithCnpj() throws Exception {
		BDDMockito.given(this.companyService.findByCnpj(Mockito.anyString()))
				.willReturn(Optional.of(this.initCompany()));

		mvc.perform(MockMvcRequestBuilders.get(FIND_COMPANY_BY_CNPJ + CNPJ)
